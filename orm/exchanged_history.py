...
class ExchangedHistoryModule(DataBase):

    __tablename__ = 'exchanged_history'
    ...
    exchanged_transactor = Column(String(64), nullable=False, index=True)  # 处理人
    exchanged_date_time = Column(DateTime, default=datetime.now())  # 兑换时间
    ...
    # 可以在类里面写别的方法,类似查询方法
    @classmethod
    def get_all_exchanged_history(cls):
